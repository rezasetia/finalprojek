...
if (isset($_POST['nbarang'], $_POST['harga'], $_POST['whatsapp'], $_POST['kondisi'], $_POST['deskripsi'], $_POST['lokasi'])) {
    $username = $_SESSION['username'];
    $nama_barang = $_POST['nbarang'];
    // Hilangkan karakter non-numerik seperti koma atau titik pada harga
    $harga_barang = preg_replace('/(?<=\d)\./', '', $_POST['harga']);
    ...
    $query = "INSERT INTO detail_barang (username, nama_barang, harga_barang, nomor_telepon, kondisi, deskripsi_barang, lokasi_barang, gambar_barang_1, gambar_barang_2, gambar_barang_3, gambar_barang_4) 
