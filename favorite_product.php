...
if ($result->num_rows > 0) {
    ...
    <div class="mb-44 mt-24">
        ...
        <div class="grid grid-cols-5 justify-center gap-x-10 mx-32">
            <?php
            foreach ($rows as $row) {
                ...
                ?>
                <div class="group flex mt-10 justify-center md:col-span-1 max-w-screen-xl md:max-w-xs flex-col overflow-hidden bg-card-ec hover:shadow-xl">
